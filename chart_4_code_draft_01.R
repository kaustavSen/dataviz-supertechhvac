...
colors <- c("Food & beverages carryout boxes" = "#1d3557ff",
            ...
            "Metal and electrical machinery" = "#2a9d8f")
...
labels_table <- tibble(
  date = ymd(20190101),
  index_value = c(208, 316, 351, 369),
  type = c("Metal and electrical machinery", "Food & beverages carryout boxes", "All other end uses", "Paper and allied products")
)
...
ggsave("plots/chart_4_bls_cardboard_index_draft_01.png", width = 8, height = 5)
