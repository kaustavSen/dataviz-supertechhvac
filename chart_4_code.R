...
index_data %>% 
  ...
  annotate("text", x = ymd(20200715), y = 380, 
  ...
  scale_x_date(date_breaks = "3 months", 
               date_labels = "%b-%y") +
  scale_y_continuous(limits = c(280, 415), expand = expansion(0)) +
...
ggsave("plots/chart_4_bls_cardboard_index.png", width = 8, height = 5)
